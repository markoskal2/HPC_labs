...
int main(int argc, char **argv) {
    ...
    *h_OutputGPU;
    ...
    CUDAsafeCall(cudaMalloc((void **) &d_Input, imageW * imageH * sizeof(double)));
    CUDAsafeCall(cudaMalloc((void **) &d_Buffer, imageW * imageH * sizeof(double)));
    ...
    CUDAsafeCall(cudaMemcpy(d_Input, h_Input, imageW * imageH * sizeof(double), cudaMemcpyHostToDevice));
