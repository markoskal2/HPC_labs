...
int main(int argc, char **argv) {
    ...
    *h_InputGPU;
    ...
    printf("Total GPU time: %10g sec\n", (double) (tv3.tv_nsec - tv2.tv_nsec)/1000000000.0 + (double) (tv3.tv_sec - tv2.tv_sec));
    
    printf("Total GPU time: %10g sec\n", (double) (tv3.tv_nsec - tv1.tv_nsec)/1000000000.0 + (double) (tv3.tv_sec - tv1.tv_sec));
